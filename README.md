...
Current screening (low-dose CT) is only recommended for high-risk smokers, leaving the majority of the population unscreened and left to wait roughly 8.8 weeks before a CT Scan. A minimally invasive blood-based test could change this.
